  ...
  return (
    <div className="max-w-6xl mx-auto px-6 py-8">
      ...
      <div className="bg-white border border-stone-200 rounded-xl p-4 mb-6 flex flex-wrap items-center gap-3">
        ...
        <Select value={sort} onChange={setSort} options={sortOptions} className="text-xs" />
      ...
      {filtered.length === 0 && (
        <div className="py-20 text-center">
          ...
          <h3 className="font-display text-lg font-semibold text-stone-700 mb-1">
            No courses found
          </h3>
  ...
  return (
    ...
    >
      ...
      <div className="p-4">
        ...
        <h3 className="text-sm font-semibold text-stone-900 leading-snug mb-2 group-hover:text-indigo-700 transition-colors line-clamp-2">
          {course.title}
        </h3>
  ...
  return (
    ...
    >
      <img
        src={course.coverImage}
        alt={course.title}
        className="w-24 h-16 rounded-lg object-cover bg-stone-100 shrink-0"
      />
      <div className="flex-1 min-w-0">
        ...
        <h3 className="text-sm font-semibold text-stone-900 group-hover:text-indigo-700 transition-colors">
          {course.title}
        </h3>
