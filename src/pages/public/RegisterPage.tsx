      ...
      >
        <div className="w-full max-w-sm text-center">
          ...
          <p className="text-sm text-ink-3 mb-6">
            We sent a verification link to <strong className="text-ink-1">{form.email}</strong>.
    ...
    <div className="min-h-screen flex transition-theme" style={{ background: "var(--bg)" }}>
      ...
      <div className="hidden lg:flex flex-col justify-between w-[420px] shrink-0 bg-gray-900 p-10">
        <div>
          ...
          <p className="text-gray-400 text-sm leading-relaxed">
            Create your account and get instant access to expert-led courses across engineering,
      ...
      <div className="flex-1 flex items-center justify-center p-6 sm:p-10">
        <div className="w-full max-w-sm">
          ...
          <h1 className="font-display text-2xl font-semibold text-ink-1 mb-1">
            Create your account
          </h1>
                ...
                <div className="flex gap-1 mt-1.5">
                  {[...Array(4)].map((_, i) => (
                    <div
                      ...
                      style={
                        form.password.length <= i * 3 ? { background: "var(--surface-3)" } : {}
                      }
                    />
                  ))}
                </div>
              ...
              <div className="grid grid-cols-2 gap-2">
                {[
                  ...
                  >
                    ...
                    <div
                      className={`text-xs font-semibold ${form.role === r.value ? "text-indigo-700 dark:text-indigo-300" : "text-ink-1"}`}
                    >
                      {r.label}
                    </div>
