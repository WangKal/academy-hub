      ...
      <div className="hidden lg:flex flex-col justify-between w-[420px] shrink-0 bg-gray-900 p-10">
        <div>
          ...
          <blockquote className="text-gray-300 font-display text-xl font-medium leading-relaxed italic">
            "The Advanced React course completely changed how I think about component architecture.
            Worth every minute."
          </blockquote>
          <div className="mt-4 text-sm text-gray-500">
            — Yuki Tanaka, Senior Engineer at Stratos Tech
          </div>
        </div>

        <div className="space-y-3 text-sm text-gray-500">
          <div className="flex items-center gap-2">
            <span className="text-emerald-400">✓</span> 94 expert-led courses
          </div>
          <div className="flex items-center gap-2">
            <span className="text-emerald-400">✓</span> Verified certificates
          </div>
          <div className="flex items-center gap-2">
            <span className="text-emerald-400">✓</span> Progress tracking & assessments
          </div>
        </div>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center p-6 sm:p-10">
        <div className="w-full max-w-sm">
          ...
          <p className="text-sm text-ink-3 mb-6">
            ...
            {redirectPage && (
              <span className="text-indigo-600">You'll be returned to your course.</span>
            )}
          </p>
          ...
          >
            <div className="text-xs font-semibold text-ink-4 uppercase tracking-wider mb-2">
              Demo accounts
            </div>
