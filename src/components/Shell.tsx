  ...
  return (
    <div className="flex h-full overflow-hidden bg-stone-50">
      ...
      >
        {/* Logo + collapse */}
        <div
          className={`flex items-center h-14 px-3 border-b border-gray-800 shrink-0 ${collapsed ? "justify-center" : "justify-between"}`}
        >
          {!collapsed && (
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        {/* Top bar */}
        <header
          className="h-14 flex items-center px-4 gap-3 shrink-0 z-10 border-b"
        ...
        >
          ...
          <div className="flex-1 max-w-sm">
            <div className="relative">
              ...
              />
              <kbd className="absolute right-3 top-1/2 -translate-y-1/2 text-[10px] text-stone-300 font-mono hidden sm:block">
                ⌘K
              </kbd>
            </div>
          </div>
          ...
          <div className="flex items-center gap-1 ml-auto">
            ...
            <div className="relative">
              ...
              {profileOpen && (
                <div
                  className="absolute right-0 top-full mt-2 w-52 rounded-xl shadow-xl z-50 py-1 border"
                  style={{ background: "var(--surface)", borderColor: "var(--edge)" }}
                >
                  ...
                  {["Profile", "Settings", "Help"].map((item) => (
                    <button
                      key={item}
                      className="w-full text-left px-3 py-1.5 text-sm text-ink-2 hover:bg-stone-50 dark:hover:bg-stone-800 transition-colors"
                    >
                      {item}
                    </button>
                  ))}
...
function HomeIcon() {
  return (
    <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
      <path
        d="M1.5 6.5L8 1.5l6.5 5V14a.5.5 0 0 1-.5.5H10V10H6v4.5H2a.5.5 0 0 1-.5-.5V6.5Z"
        stroke="currentColor"
        strokeWidth="1.3"
        strokeLinejoin="round"
      />
...
function BookOpenIcon() {
  return (
    <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
      <path
        d="M8 13.5c0 0-5.5-2-5.5-8V2.5L8 4.5l5.5-2V5.5c0 6-5.5 8-5.5 8Z"
        stroke="currentColor"
        strokeWidth="1.3"
        strokeLinejoin="round"
      />
      <line x1="8" y1="4.5" x2="8" y2="13.5" stroke="currentColor" strokeWidth="1.3" />
    </svg>
  );
}
function LayersIcon() {
...
function BellIcon() {
  return (
    <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
      <path
        d="M8 1.5a5 5 0 0 1 5 5v3.5l1.5 1.5H1.5L3 10V6.5a5 5 0 0 1 5-5Z"
        stroke="currentColor"
        strokeWidth="1.3"
        strokeLinejoin="round"
      />
...
function UsersIcon() {
  return (
    <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
      ...
      <path
        d="M1.5 13c0-2.5 2-3.5 4.5-3.5s4.5 1 4.5 3.5"
        stroke="currentColor"
        strokeWidth="1.3"
        strokeLinecap="round"
      />
      <path
        d="M10.5 4a2 2 0 1 1 0 4M12 9.5c2 0 3 1 3 3"
        stroke="currentColor"
        strokeWidth="1.3"
        strokeLinecap="round"
      />
...
function EditIcon() {
  return (
    <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
      <path
        d="M9.5 3.5 12.5 6.5 5.5 13.5H2.5v-3L9.5 3.5Z"
        stroke="currentColor"
        strokeWidth="1.3"
        strokeLinejoin="round"
      />
      <line x1="8" y1="5" x2="11" y2="8" stroke="currentColor" strokeWidth="1.3" />
    </svg>
  );
}
function ChartIcon() {
  return (
    <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
      <rect x="2" y="8" width="3" height="5.5" rx="1" stroke="currentColor" strokeWidth="1.3" />
      <rect x="6.5" y="5" width="3" height="8.5" rx="1" stroke="currentColor" strokeWidth="1.3" />
      <rect x="11" y="2.5" width="3" height="11" rx="1" stroke="currentColor" strokeWidth="1.3" />
    </svg>
  );
}
function BuildingIcon() {
  return (
    <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
      ...
      <path d="M6 7v7M10 7v7" stroke="currentColor" strokeWidth="1.3" />
      <path d="M5 3V2h6v1" stroke="currentColor" strokeWidth="1.3" strokeLinejoin="round" />
    </svg>
  );
}
function CreditCardIcon() {
  return (
    <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
      ...
      <rect x="3.5" y="9" width="4" height="1.5" rx="0.5" fill="currentColor" />
    </svg>
  );
}
function ShieldIcon() {
  return (
    <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
      <path
        d="M8 1.5 2.5 4v4c0 3 2.5 5.5 5.5 6 3-0.5 5.5-3 5.5-6V4L8 1.5Z"
        stroke="currentColor"
        strokeWidth="1.3"
        strokeLinejoin="round"
      />
