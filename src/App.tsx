...
export default function App() {
  ...
  if (FULLSCREEN_PAGES.has(currentPage)) {
    return <CoursePlayer courseId={params.courseId ?? "crs_001"} onNavigate={navigate} />;
  }
    ...
    return (
      <div className="transition-theme" style={{ minHeight: "100vh", background: "var(--bg)" }}>
        ...
        {currentPage === "register" && (
          <RegisterPage onNavigate={navigate} onSignIn={handleSignIn} />
        )}
        {currentPage === "forgot-password" && <ForgotPassword onNavigate={navigate} />}
        {currentPage === "verify" && (
          <VerificationPage onNavigate={navigate} onSignIn={() => handleSignIn("student")} />
        )}
      </div>
    );
  }
...
function AuthPageContent({
  ...
  if (page === "course-detail")
    return <CourseDetail courseId={params.courseId ?? "crs_001"} onNavigate={onNavigate} />;
  ...
  if (page === "course-builder")
    return <CourseBuilder courseId={params.courseId} onNavigate={onNavigate} />;
          ...
          >
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="text-xs text-ink-4 mt-1 font-mono">
                {enrollment.completedLessons.length}/{course.totalLessons} lessons · Last accessed{" "}
                {relativeTime(enrollment.lastAccessedAt)}
              </div>
            </div>
    ...
    <div className="max-w-2xl mx-auto px-4 sm:px-6 py-8">
      ...
      <div className="space-y-2">
        {notifications.map((n) => (
          ...
          >
            <div
              className={`w-1.5 h-1.5 rounded-full mt-2 shrink-0 ${!n.read ? "bg-indigo-500" : "bg-stone-300"}`}
            />
    ...
    <div className="max-w-2xl mx-auto px-4 sm:px-6 py-8">
      ...
      >
        ...
        <div className="px-5 sm:px-6 pb-6">
          ...
          <p className="text-sm text-ink-3 capitalize">
...
function InstructorStudentsPage() {
  const cols: Column<User>[] = [
    ...
    },
    {
      key: "organization",
      label: "Organization",
      render: (r) => <span className="text-ink-2">{r.organization}</span>,
    },
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 py-8">
      <PageHeader
        title="Students"
        description={`${instructorStudents.length} students enrolled in your courses.`}
      />
      <div
    ...
    <div className="max-w-5xl mx-auto px-4 sm:px-6 py-8">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-6">
        <MetricCard
          ...
          icon={<span className="text-ink-4">📈</span>}
        />
        <MetricCard
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
        <div
          ...
          style={{ background: "var(--surface)", borderColor: "var(--edge)" }}
        >
          <h3 className="font-display text-sm font-semibold text-ink-1 mb-4">
            Monthly enrollments
          </h3>
          <BarChart
...
function AdminCoursesPage() {
  const cols: Column<Course>[] = [
    ...
    },
    {
      key: "instructor",
      label: "Instructor",
      render: (r) => <span className="text-ink-2">{r.instructor.name}</span>,
    },
    {
      key: "category",
      label: "Category",
      render: (r) => <span className="text-ink-3">{r.category}</span>,
    },
  ...
  const cols: Column<Enrollment>[] = [
    {
      ...
      render: (r) => (
        <span className="text-ink-2">
          {courses.find((c) => c.id === r.courseId)?.title ?? r.courseId}
        </span>
      ),
    },
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 py-8">
      <PageHeader
        ...
        actions={<Btn size="sm">Issue certificate</Btn>}
      />
      <div
        className="rounded-xl overflow-hidden border"
        style={{ background: "var(--surface)", borderColor: "var(--edge)" }}
          ...
          columns={[
            {
              key: "name",
              label: "Organization",
              render: (r) => <span className="font-medium text-ink-1">{r.name}</span>,
            },
  ...
  return (
    <div className="max-w-2xl mx-auto px-4 sm:px-6 py-8">
      <PageHeader
        ...
        description="Configure Academy Hub platform-wide settings."
      />
