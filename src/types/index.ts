...
export type PermissionKey =
  ...
  | "sponsorships.view_students"
  | "sponsorships.view_progress"
  | "sponsorships.view_certificates"
  | "sponsorships.view_reports"
  | "sponsorships.manage"
  | "payments.view"
  | "payments.create"
  | "payments.edit"
...
export interface CurrentUser {
  ...
  /** All administrative tiers assigned to this administrator. */
...
export interface Course {
  ...
  /** Legacy/primary instructor retained for compatibility. */
  instructorId: string;
