...
export const courses: Course[] = [
  {
    ...
    level: 'Advanced',
    price: 189,
    coverImage: 'https://images.unsplash.com/photo-1633356122544-f134324a6cee?w=800&h=450&fit=crop&auto=format',
    description:
    ...
    modules: [
      {
        ...
        order: 1,
        lessons: [
          { id: 'les_001', title: 'Component Composition Philosophy', type: 'video', duration: 28, preview: true },
  ...
  },
  {
    ...
    level: 'Beginner',
    price: 129,
    coverImage: 'https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=800&h=450&fit=crop&auto=format',
    description:
  ...
  },
  {
    ...
    level: 'Intermediate',
    price: 159,
    coverImage: 'https://images.unsplash.com/photo-1561070791-2526d30994b5?w=800&h=450&fit=crop&auto=format',
    description:
  ...
  },
  {
    ...
    level: 'Intermediate',
    price: 149,
    coverImage: 'https://images.unsplash.com/photo-1526374965328-7f61d4dc18c5?w=800&h=450&fit=crop&auto=format',
    description:
  ...
  },
  {
    ...
    level: 'Intermediate',
    price: 199,
    coverImage: 'https://images.unsplash.com/photo-1451187580459-43490279c0fa?w=800&h=450&fit=crop&auto=format',
    description:
...
export const studentEnrollments: Enrollment[] = [
  {
    ...
    completedLessons: ['les_001', 'les_002', 'les_003', 'les_004', 'les_005', 'les_006', 'les_007', 'les_008', 'les_009', 'les_010'],
...
export const instructorStudents: User[] = [
  { id: 'usr_001', name: 'Sarah Chen', email: 'sarah.chen@meridiantech.com', role: 'student', organization: 'Meridian Technologies', joinedAt: '2024-02-01', status: 'active', enrollments: 3 },
  { id: 'usr_004', name: 'Yuki Tanaka', email: 'y.tanaka@stratostech.com', role: 'student', organization: 'Stratos Tech', joinedAt: '2024-01-08', status: 'active', enrollments: 5 },
  { id: 'usr_007', name: 'Natasha Volkov', email: 'n.volkov@dataprime.eu', role: 'student', organization: 'DataPrime EU', joinedAt: '2024-01-30', status: 'active', enrollments: 4 },
  { id: 'usr_008', name: 'Omar Hassan', email: 'o.hassan@techcorp.sa', role: 'student', organization: 'TechCorp SA', joinedAt: '2023-11-05', status: 'active', enrollments: 7 },
]
...
export const adminUsers: User[] = [
  { id: 'usr_001', name: 'Sarah Chen', email: 'sarah.chen@meridiantech.com', role: 'student', organization: 'Meridian Technologies', joinedAt: '2024-01-15', status: 'active', enrollments: 3 },
  { id: 'usr_002', name: 'Marcus Rodriguez', email: 'm.rodriguez@academyhub.io', role: 'instructor', organization: 'Academy Hub', joinedAt: '2023-06-20', status: 'active', enrollments: 0 },
  { id: 'usr_004', name: 'Yuki Tanaka', email: 'y.tanaka@stratostech.com', role: 'student', organization: 'Stratos Tech', joinedAt: '2023-12-08', status: 'active', enrollments: 5 },
  { id: 'usr_005', name: 'Fatima Al-Rashid', email: 'f.alrashid@apex.io', role: 'student', organization: 'Apex Industries', joinedAt: '2024-02-22', status: 'suspended', enrollments: 2 },
  { id: 'usr_006', name: 'Kwame Asante', email: 'k.asante@globallearn.org', role: 'instructor', organization: 'GlobalLearn', joinedAt: '2023-09-14', status: 'active', enrollments: 0 },
  { id: 'usr_007', name: 'Natasha Volkov', email: 'n.volkov@dataprime.eu', role: 'student', organization: 'DataPrime EU', joinedAt: '2024-01-30', status: 'active', enrollments: 4 },
  { id: 'usr_008', name: 'Omar Hassan', email: 'o.hassan@techcorp.sa', role: 'student', organization: 'TechCorp SA', joinedAt: '2023-11-05', status: 'active', enrollments: 7 },
  { id: 'usr_009', name: 'Lena Bergström', email: 'l.bergstrom@nordic.se', role: 'student', organization: 'Nordic Systems', joinedAt: '2024-03-01', status: 'pending', enrollments: 1 },
]

export const adminPayments: Payment[] = [
  { id: 'pay_001', user: 'Sarah Chen', course: 'Advanced React Patterns', amount: 189, status: 'succeeded', date: '2024-02-01', method: 'Visa •••• 4242' },
  { id: 'pay_002', user: 'Yuki Tanaka', course: 'Machine Learning in Production', amount: 219, status: 'succeeded', date: '2024-02-15', method: 'Mastercard •••• 8823' },
  { id: 'pay_003', user: 'Fatima Al-Rashid', course: 'UX Design Mastery', amount: 159, status: 'refunded', date: '2024-02-22', method: 'Visa •••• 1199' },
  { id: 'pay_004', user: 'Omar Hassan', course: 'Python for Enterprise', amount: 149, status: 'succeeded', date: '2024-03-05', method: 'Stripe' },
  { id: 'pay_005', user: 'Natasha Volkov', course: 'Data Science Fundamentals', amount: 129, status: 'failed', date: '2024-03-08', method: 'Visa •••• 7731' },
  { id: 'pay_006', user: 'Lena Bergström', course: 'Advanced React Patterns', amount: 189, status: 'pending', date: '2024-03-12', method: 'Bank Transfer' },
]

export const auditLogs: AuditLog[] = [
  { id: 'log_001', actor: 'Aisha Okonkwo', action: 'user.suspend', target: 'Fatima Al-Rashid', ip: '192.168.1.42', timestamp: '2024-03-14T09:31:00Z', severity: 'high' },
  { id: 'log_002', actor: 'System', action: 'payment.failed', target: 'pay_005 — Natasha Volkov', ip: '—', timestamp: '2024-03-08T14:22:00Z', severity: 'medium' },
  { id: 'log_003', actor: 'Marcus Rodriguez', action: 'course.publish', target: 'Advanced React Patterns & Architecture', ip: '203.0.113.5', timestamp: '2024-03-07T11:15:00Z', severity: 'low' },
  { id: 'log_004', actor: 'System', action: 'certificate.issue', target: 'cert_001 — Sarah Chen', ip: '—', timestamp: '2024-01-20T09:00:00Z', severity: 'low' },
  { id: 'log_005', actor: 'Aisha Okonkwo', action: 'user.role_change', target: 'Kwame Asante → instructor', ip: '192.168.1.42', timestamp: '2023-09-14T16:45:00Z', severity: 'high' },
  { id: 'log_006', actor: 'System', action: 'user.verification_sent', target: 'Lena Bergström', ip: '—', timestamp: '2024-03-01T08:12:00Z', severity: 'low' },
]
