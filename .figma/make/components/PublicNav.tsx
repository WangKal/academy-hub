...
export default function PublicNav({ currentPage, onNavigate, onSignIn, darkMode, onToggleDark }: Props) {
  ...
  return (
    <>
      <nav className="fixed top-0 left-0 right-0 z-50 transition-theme"
        ...
        {/* Mobile nav drawer */}
        {mobileOpen && (
          <div className="md:hidden border-t transition-theme" style={{ borderColor: 'var(--edge)', background: 'var(--surface)' }}>
...
function MoonIcon() {
  return <svg width="16" height="16" viewBox="0 0 16 16" fill="none"><path d="M14 9.5A6.5 6.5 0 0 1 6.5 2 6.5 6.5 0 1 0 14 9.5Z" stroke="currentColor" strokeWidth="1.3" strokeLinejoin="round"/></svg>
}
function SunIcon() {
  return <svg width="16" height="16" viewBox="0 0 16 16" fill="none"><circle cx="8" cy="8" r="3" stroke="currentColor" strokeWidth="1.3"/><path d="M8 1v2M8 13v2M1 8h2M13 8h2M3.05 3.05l1.41 1.41M11.54 11.54l1.41 1.41M11.54 4.46l-1.41 1.41M4.95 11.54l-1.41 1.41" stroke="currentColor" strokeWidth="1.3" strokeLinecap="round"/></svg>
}
function MenuIcon() {
...
function CloseIcon() {
  return <svg width="16" height="16" viewBox="0 0 16 16" fill="none"><path d="M4 4l8 8M12 4l-8 8" stroke="currentColor" strokeWidth="1.3" strokeLinecap="round"/></svg>
}
